...
export default function Hero() {
  ...
  return (
    <section id="hero" className="hero-gradient text-white relative overflow-hidden pt-20 pb-16 md:pt-28 md:pb-20">
          ...
          >
            ...
            >
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-4">
                Start Your <span className="text-yellow-300">Dropshipping</span> Business Today!
              </h1>
            </motion.div>
            ...
            >
              <p className="text-xl lg:text-2xl mb-8 text-white/90">
                Sell 10,000+ trending products under your own brand name with <strong>zero inventory</strong> and <strong>zero risk</strong>.
              </p>
            </motion.div>
            ...
            >
              <div className="flex items-center">
                ...
                <span className="text-sm md:text-base">No investment required</span>
              </div>
              <div className="flex items-center">
                <CheckCircle className="h-5 w-5 mr-2 text-green-400" />
                <span className="text-sm md:text-base">No inventory to manage</span>
              </div>
              <div className="flex items-center">
                <CheckCircle className="h-5 w-5 mr-2 text-green-400" />
                <span className="text-sm md:text-base">Shipping across India</span>
              </div>
              <div className="flex items-center">
                <CheckCircle className="h-5 w-5 mr-2 text-green-400" />
                <span className="text-sm md:text-base">High profit margins</span>
              </div>
            </motion.div>
          ...
          >
            <div className="relative">
              ...
              <div className="relative rounded-xl overflow-hidden shadow-2xl border-4 border-white/20">
                <img 
                  src="https://images.unsplash.com/photo-1613288030301-b0f14d5db5c9?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80" 
      ...
      <div className="text-light mt-10">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 150">
          <path fill="currentColor" fillOpacity="1" d="M0,64L60,80C120,96,240,128,360,128C480,128,600,96,720,74.7C840,53,960,43,1080,48C1200,53,1320,75,1380,85.3L1440,96L1440,150L1380,150C1320,150,1200,150,1080,150C960,150,840,150,720,150C600,150,480,150,360,150C240,150,120,150,60,150L0,150Z"></path>
        </svg>
      </div>
    </section>
  );
