...
import { ArrowRight, UserPlus, PackageSearch, Share2, DollarSign, PlusCircle } from "lucide-react";

const steps = [
  {
    number: 1,
    title: "Sign Up",
    description: "Join as a reseller for free. No technical knowledge needed.",
  ...
  },
  {
    ...
    description: "Browse 10,000+ high-margin products across categories.",
  ...
  },
  {
    number: 3,
    title: "Share & Sell",
    description: "Market products on your social media, WhatsApp or website.",
  ...
  },
  {
    number: 4,
    title: "Earn Profits",
    description: "We handle inventory, shipping & delivery - you earn profits.",
    ...
    <section id="how-it-works" className="bg-gradient-to-b from-gray-50 to-white py-20">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">How BaapDrop Works</h2>
          <p className="text-gray-600 max-w-2xl mx-auto text-lg">
            Our platform makes it incredibly easy to start your own dropshipping business without any hassle.
          </p>
        </motion.div>
          ...
          >
            {steps.map((step, index) => (
              ...
              >
                ...
                {/* Icon */}
                <div className={`${step.color} text-white rounded-2xl p-4 inline-flex mb-6 shadow-lg`}>
                  {step.icon}
                </div>
        ...
        >
          ...
          <div className="flex items-center gap-2 text-gray-600 bg-gray-100 px-5 py-2 rounded-lg">
            <span className="text-4xl font-bold text-primary">10000+</span>
            <span className="text-sm font-medium">Products<br/>Available</span>
          </div>
        </motion.div>
          ...
          {[
            {
              ...
              description: "Start selling without any upfront costs or risks",
              bgColor: "bg-blue-50"
            },
            {
              title: "Fast Shipping",
              description: "Quick delivery to your customers across India",
              bgColor: "bg-purple-50"
            },
            {
              title: "Own Branding",
              description: "Sell under your brand with personalized packaging",
              bgColor: "bg-pink-50"
            }
          ].map((feature, index) => (
            <motion.div 
