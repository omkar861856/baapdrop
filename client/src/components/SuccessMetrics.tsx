...
const successStories = [
  {
    ...
    quote:
      "I started dropshipping as a side hustle while working full-time. Within 3 months, I was making more from BaapDrop than my day job!",
  },
  {
    id: 2,
    name: "Rahul S.",
    ...
    quote:
      "The platform simplified everything. I focus on marketing while they handle logistics. My electronics store grew 300% in the first year.",
  },
  {
    id: 3,
    name: "Aisha K.",
    ...
    quote:
      "I never thought I could run a successful online business with zero inventory. Home decor has amazing margins and customers love the quality.",
  },
  {
    id: 4,
    name: "Vikram P.",
    ...
    quote:
      "The beauty market is booming, and with BaapDrop's white-labeled packaging, my customers think it's all my brand. The repeat orders are incredible.",
  },
  {
    id: 5,
    name: "Neha G.",
    ...
    quote:
      "As a mother of two, I know what parents look for. This platform let me build a kids' store that generates passive income while I care for my family.",
  },
];
...
export default function SuccessMetrics() {
  ...
  const calculateAverages = () => {
    const totalProfit = successStories.reduce(
      (sum, story) => sum + story.monthlyProfit,
      0
    );
    const avgProfit = totalProfit / successStories.length;

    const totalGrowth = successStories.reduce(
      (sum, story) => sum + story.growth,
      0
    );
    const avgGrowth = totalGrowth / successStories.length;

    const totalOrders = successStories.reduce(
      (sum, story) => sum + story.ordersPerMonth,
      0
    );
    const avgOrders = totalOrders / successStories.length;

    const totalConversion = successStories.reduce(
      (sum, story) => sum + story.conversionRate,
      0
    );
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">
            Reseller Success Metrics
          </h2>
          <p className="text-gray-600 max-w-2xl mx-auto text-lg">
            Real performance data from our top resellers. See what's possible
                    ...
                    >
                      ...
                      <div className="text-right">
                        <p className="text-sm font-medium text-primary">
                          {formatCurrency(story.monthlyProfit)}
                        </p>
                      ...
                      <div className="flex justify-between">
                        ...
                        <div className="flex flex-col items-end">
                          ...
                          <span className="text-lg font-bold text-primary">
                            {selectedStory.monthsActive} months
                          </span>
                        </div>
                      </div>
                    </CardHeader>
                  ...
                  <CardHeader>
                    <div className="flex justify-between items-center">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <Button
                          variant={
                            chartView === "radar" ? "default" : "outline"
                          }
                          size="sm"
              ...
              <TabsContent value="metrics" className="h-full">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                  ...
                  <Card>
                    <CardHeader>
                      <CardTitle className="text-lg">
                        Seller vs. Industry Average
                      </CardTitle>
                      <CardDescription>
                        How our sellers outperform industry standards
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      <div className="h-[300px]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                  <MetricCard
                    ...
                    description={`vs. industry: ${formatCurrency(
                      industryAverages.monthlyProfit
                    )}`}
                    bgColor="bg-white"
              ...
              <TabsContent value="growth" className="h-full">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Profit growth over time (months)
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    ...
                    <CardContent>
                      <div className="text-center py-4">
                        ...
                        <p className="text-gray-600">
                          Our average seller reaches breakeven in just{" "}
                          <span className="font-semibold text-primary">
                            2 months
                          </span>{" "}
                          compared to the industry average of 4.5 months
                        </p>
                      </div>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="bg-gradient-to-br from-red-50 to-orange-50 border-red-100">
                    ...
                    <CardContent>
                      <div className="text-center py-4">
                        ...
                        <p className="text-gray-600">
                          Top sellers achieve an average{" "}
                          <span className="font-semibold text-primary">
                            320% growth
                          </span>{" "}
        ...
        >
          <p className="text-gray-600 max-w-2xl mx-auto mb-8">
            Ready to join these successful resellers? Get started today and
