  ...
  return (
    <div className={`fixed bottom-6 ${position === "right" ? "right-6" : "left-6"} z-50`}>
          ...
          >
            <div className="flex justify-between items-center mb-3">
              <div className="flex items-center">
                <div className="bg-[#E40145] p-2 rounded-full mr-2">
            ...
            <button
              ...
              className="bg-[#E40145] hover:bg-[#c9013c] text-white w-full py-2 rounded-lg font-medium flex items-center justify-center"
            >
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.9 }}
        onClick={handleToggle}
        className={`bg-[#E40145] text-white p-3.5 rounded-full shadow-lg flex items-center justify-center relative ${isOpen ? 'ring-4 ring-[#E40145]/30' : ''}`}
      >
