...
const benefits = [
  {
    ...
    description: "Start your business with no upfront costs, inventory, or risk.",
    color: "bg-blue-500"
  },
  {
  ...
  },
  {
    ...
    title: "Quick Start",
    description: "Begin selling in minutes with our simple, intuitive platform.",
    color: "bg-yellow-500"
  },
  {
    icon: <Users className="h-8 w-8" />,
    title: "Dedicated Support",
    description: "Get help anytime via WhatsApp, phone, or email from our team.",
    color: "bg-indigo-500"
  },
  {
    ...
    <section id="why-us" className="py-24 bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">Why Choose BaapDrop?</h2>
          <p className="text-gray-600 max-w-2xl mx-auto text-lg">
            We provide everything you need to build a successful dropshipping business without the hassle.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-10">
          {benefits.map((benefit, index) => (
            ...
            >
              <div className={`${benefit.color} w-16 h-16 rounded-2xl flex items-center justify-center text-white mb-5 shadow-lg`}>
                {benefit.icon}
              </div>
        ...
        <motion.div 
          ...
          transition={{ duration: 0.5 }}
        >
          <h3 className="text-2xl font-bold mb-4">Join Thousands of Successful Resellers</h3>
          <p className="text-gray-600 max-w-2xl mx-auto mb-8">
            Our platform has helped people from all walks of life build successful online businesses. You could be next!
          </p>
